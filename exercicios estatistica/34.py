...
# c. Valor crítico z_c e margem de erro E
conf_level = 0.90
alpha = 1 - conf_level
...
ic_inf = p_hat - E
ic_sup = p_hat + E
print(f"\nd) Intervalo de confiança 90% para a proporção:")
print(f"   ({ic_inf:.5f}, {ic_sup:.5f})")

# e. Interpretação
print("\ne) Interpretação:")
print(f"Com 90% de confiança, a proporção verdadeira de professores que consideram")
print(f"todas ou quase todas as informações corretas está entre {ic_inf:.4f} e {ic_sup:.4f}.")
